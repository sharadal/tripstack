    ...
    return (
      <main className="flex-1 bg-stone-50">
        <div className="mx-auto max-w-2xl px-6 py-24 text-center">
          ...
          <Link
            href="/#upcoming"
            className="mt-6 inline-flex items-center justify-center rounded-full bg-teal-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-teal-900"
          >
            ← Back to trips
          </Link>
        </div>
