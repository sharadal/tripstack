    ...
    <main className="flex-1 bg-stone-50 dark:bg-slate-950">
      <section className="relative overflow-hidden px-6 py-20 text-white sm:py-28">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          {upcoming && (
            <div
              className="animate-fade-in-up group mt-8 inline-flex max-w-md flex-wrap items-center gap-6 rounded-2xl bg-stone-50 px-6 py-5 text-slate-900 shadow-lg transition-transform duration-300 hover:-translate-y-1 sm:flex-nowrap dark:bg-slate-900 dark:text-slate-50"
              style={{ animationDelay: "240ms" }}
            >
              <div>
                <p className="flex items-center gap-1.5 text-xs font-semibold tracking-[0.15em] text-slate-500 uppercase dark:text-slate-400">
              ...
              <div className="border-l border-slate-200 pl-6 dark:border-slate-700">
                <p className="text-3xl font-bold text-orange-600 transition-transform duration-300 group-hover:scale-110 dark:text-orange-400">
        ...
        <svg
          className="absolute inset-x-0 -bottom-1 h-10 w-full text-stone-50 sm:h-14 dark:text-slate-950"
          viewBox="0 0 1440 74"
          preserveAspectRatio="none"
          fill="currentColor"
          aria-hidden="true"
      ...
      <section id="budget" className="mx-auto max-w-6xl px-6 pb-16">
        <ScrollReveal>
          <h2 className="mb-6 flex items-center gap-2 font-serif text-3xl font-bold text-slate-900 dark:text-slate-50">
            <WalletIcon className="h-7 w-7 text-teal-700 dark:text-teal-400" />
            Budget at a glance
          </h2>

          <div className="grid gap-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow duration-300 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow duration-300 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
              <p className="text-sm text-slate-500 dark:text-slate-400">Committed so far</p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow duration-300 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-1 text-2xl font-semibold text-teal-800 dark:text-teal-300">
